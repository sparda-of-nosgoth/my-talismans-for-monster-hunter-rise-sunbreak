...
export function useSkill() {
  ...
  function filterSkillsByType(skillType: SkillType): Skill[] {
    return _filter(skills.value, { type: skillType.id });
  }

  function findSkillByName(skillName: string): Skill | undefined {
