...
describe('composables/slot-icon', () => {
  describe('with a ref', () => {
    ...
    it('has a value to return if slot equals 1', async () => {
      await updateSlot(1);
      expect(slotIcon.value).toStrictEqual('img:images/icon_slot_1.svg');
    });

    it('has a value to return if slot equals 2', async () => {
      await updateSlot(2);
      expect(slotIcon.value).toStrictEqual('img:images/icon_slot_2.svg');
    });

    it('has a value to return if slot equals 3', async () => {
      await updateSlot(3);
      expect(slotIcon.value).toStrictEqual('img:images/icon_slot_3.svg');
    });

    it('has a value to return if slot equals 4', async () => {
      await updateSlot(4);
      expect(slotIcon.value).toStrictEqual('img:images/icon_slot_4.svg');
    });
  });
  ...
  describe('with a string', () => {
    ...
    it('has a value to return if slot equals 1', () => {
      expect(useSlotIcon(1).slotIcon.value).toStrictEqual('img:images/icon_slot_1.svg');
    });

    it('has a value to return if slot equals 2', () => {
      expect(useSlotIcon(2).slotIcon.value).toStrictEqual('img:images/icon_slot_2.svg');
    });

    it('has a value to return if slot equals 3', () => {
      expect(useSlotIcon(3).slotIcon.value).toStrictEqual('img:images/icon_slot_3.svg');
    });

    it('has a value to return if slot equals 4', () => {
      expect(useSlotIcon(4).slotIcon.value).toStrictEqual('img:images/icon_slot_4.svg');
    });
  });
});
